...
<div class="post-content">
	<div class="c_left">
		...
		<div class="l_font">该信息已发布在  <a href="${pageContext.request.contextPath}/uu_index.action">优优二手房</a>，可以前去首页查看信息状态。</div>
				...
				<div class="main_zd_iframe">
							...
							<div class="l_btns clearfix">
								...
								<a href="${pageContext.request.contextPath}/uu_index.action" class="p_btn">
									<span>返回首页</span>
								</a>
